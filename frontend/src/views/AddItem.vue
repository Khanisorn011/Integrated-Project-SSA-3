  ...
  <div class="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen pb-12">
    ...
    <div class="bg-white text-black px-8 py-10 mx-auto max-w-6xl rounded-2xl shadow-lg mt-8 mb-12">
      ...
      <nav class="flex items-center text-lg text-gray-600 mb-6">
        <router-link to="/sale-items" class="itbms-home-button font-medium text-blue-600 hover:text-blue-800 transition-colors">
          Home
        </router-link>
      ...
      <h1 class="text-3xl font-bold text-gray-800 mb-8 border-b border-gray-200 pb-4">Add New Product</h1>

      <form @submit.prevent="handleSubmit" class="flex flex-col md:flex-row gap-12">
        <!-- Product Image Preview -->
        <div class="md:w-1/2 w-full">
          <div class="bg-gray-50 rounded-xl border border-gray-200 shadow-sm p-3 transition-all duration-300 hover:shadow-md">
        ...
        <div class="md:w-1/2 w-full text-base itbms-row">
          <div class="bg-blue-50 rounded-xl p-6 mb-6">
            <h2 class="text-xl font-semibold text-gray-800 mb-1">Product Information</h2>
            <p class="text-gray-500 text-sm">Fill in the details below to add a new product</p>
          </div>
          ...
          <div class="space-y-5">
            ...
            <div>
              ...
              <textarea ref="description" v-model="form.description" placeholder="Enter product description"
                ...
                rows="3" @blur="trim('description')" @keydown.enter.prevent="focusNext('ramGb')"></textarea>
            </div>

            <!-- Optional Fields Section -->
            <div class="mt-8">
              <h3 class="text-gray-700 font-medium pb-2 border-b border-gray-200 mb-4">Additional Information (Optional)</h3>
              <div class="grid grid-cols-2 gap-5">
                <div>
...
const ramGb = ref(null)
const screenSizeInch = ref(null)
const storageGb = ref(null)
...
const isFormValid = computed(() =>
  form.value.brandId && form.value.model.trim() &&
