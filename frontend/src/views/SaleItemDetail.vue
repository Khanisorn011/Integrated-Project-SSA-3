<template>
  <div>
    ...
    <nav class="text-L text-gray-700 px-6 pt-6 max-w-6xl mx-auto">
      <router-link to="/sale-items" class="text-blue-600 hover:underline">
        Home
      </router-link>
    ...
    <!-- Product Detail -->
    <div v-if="product" class="bg-white text-black px-6 py-10 mx-auto max-w-6xl">
      <div class="flex flex-col md:flex-row gap-10">
        ...
        <div class="md:w-1/2 w-full space-y-4 text-base Itbms-row">
          ...
          <p class="text-3xl font-bold text-blue-600">
            ...
            <span class="Itbms-price-unit pl-1">Baht</span>
          </p>
    ...
    <transition name="fade">
      ...
      >
        <div class="bg-white p-6 rounded-xl shadow-lg max-w-md text-center">
          ...
          <button
            @click="goBack"
            class="Itbms-button px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition"
          >
            ok
          </button>
        </div>
