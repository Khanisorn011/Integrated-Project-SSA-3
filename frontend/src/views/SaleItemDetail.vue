      ...
      <div class="flex flex-col md:flex-row gap-10">
        ...
        <div class="md:w-1/2 w-full space-y-4 text-base itbms-row">
          ...
          <div class="grid grid-cols-2 gap-y-3 gap-x-4 mt-6 text-sm">
            ...
            <p>
              <strong>Model: </strong><span class="itbms-model" :class="{ 'text-gray-400': !product.model?.trim() }">{{
                product.model || "-" }}</span>
            </p>
            <p>
            ...
            <p>
              <strong>Color: </strong><span class="itbms-color" :class="{ 'text-gray-400': !product.color?.trim() }">{{
                product.color || "-" }}</span>
            </p>
            <p>
